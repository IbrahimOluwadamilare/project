...
public class clschecklist extends B4AClass.ImplB4AClass{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "www.computerdictionary.com.clschecklist");
            if (htSubs == null) {
...
int _i = 0;
www.computerdictionary.com.clschecklist._typsortdata _sortdata = null;
int _firsttosort = 0;
int _lasttosort = 0;
...
_sortdata = new www.computerdictionary.com.clschecklist._typsortdata();
...
_sortdata = (www.computerdictionary.com.clschecklist._typsortdata)(_sortlist.Get((int)(_i-_firstposition)));
