...
{
    public partial class KidnapPivot : PhoneApplicationPage
    {
        public KidnapPivot()
        {
            InitializeComponent();
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (NavigationContext.QueryString.ContainsKey("item"))
            {
                ...
                kidnappivot.SelectedIndex = indexParsed;
            }
        ...
        public void kidnappivot_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            string pivotResource;

            switch (kidnappivot.SelectedIndex)
            {
                case 0:
